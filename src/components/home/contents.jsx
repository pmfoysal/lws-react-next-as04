				...
				<div className='col-span-12 grid grid-cols-12 gap-6 self-start xl:col-span-8'>
					<div className='col-span-12 grid grid-cols-12 gap-4'>
						<div className='col-span-12 lg:col-span-4'>
							...
							<p className='text-base text-[#5C5955]'>
								...
								to thrive again if its cities don’t—they’re the places that have historically supplied the keys
								for unlocking human potential. Though beset by racism and other injustices, cities not only
								provided shared, robust public infrastructure like schools, libraries and transit systems, they
								stirred together vast numbers of people from different cultures and classes.
							</p>
					...
					<div className='col-span-12 md:col-span-6 lg:col-span-4'>
						<div className='col-span-12 md:col-span-4'>
							...
							<p className='text-base text-[#292219]'>
								Companies will face questioning from investors on how to allow allocate excess funds
							</p>
					...
					<div className='col-span-12 md:col-span-6 lg:col-span-4'>
						<div className='col-span-12 md:col-span-4'>
							...
							<p className='text-base text-[#292219]'>
								Why it is usually a mistake for investors to take profitsA tiny number of superstar companies
					...
					<div className='col-span-12 md:col-span-6 lg:col-span-4'>
						<div className='col-span-12 md:col-span-4'>
							<a href='#'>
								<h3 className='mb-2.5 text-xl font-bold lg:text-2xl'>Bitcoin cannot replace the banks</h3>
							</a>
							<p className='text-base text-[#292219]'>
					...
					<div className='space-y-6 divide-y-2 divide-[#D5D1C9]'>
						...
						<div className='col-span-12 md:col-span-8'>
							<div className='col-span-12 md:col-span-4'>
								...
								<p className='text-base text-[#292219]'>
									True liberals stand for individual freedom, explains Deirdre Nansen McCloskey, an
