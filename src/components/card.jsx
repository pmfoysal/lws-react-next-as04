	...
	if (type === 'hero') {
		return (
			<div className='col-span-12 grid grid-cols-12 gap-4'>
				...
				<div className='col-span-12 lg:col-span-8'>
					<img className='w-full' src={urlToImage || 'https://placehold.co/656x385'} alt={title} />
		...
		return (
			<div className='col-span-12 mb-0 md:col-span-8'>
				<img className='w-full' src={urlToImage || 'https://placehold.co/480x240'} alt={title} />
		...
		return (
			<div className='col-span-12 grid grid-cols-12 gap-4 lg:col-span-8'>
				...
				<div className='col-span-12 md:col-span-6'>
					<img className='w-full' src={urlToImage || 'https://placehold.co/320x210'} alt={title} />
				</div>
			</div>
		);
	} else if (type === 'side') {
